...
<div class="top-bar">
    ...
    <div class="container">
        ...
        <!-- ************ STATISTIC SUMMARY ************** -->
        <div class="head-div">
            <a href="dashboard.php" class="stat-summary"><p>Statistic Summary</p></a>
        </div>
        <div class="stat-box">
                <div class="stat">
                    <h3>23</h3>
                    <p class="stat-detail">Number of Members </p>
                </div>
                <div class="stat">
                    <h3>5</h3>
                    <p class="stat-detail">Administrative Shooter</p>
                </div>
                <div class="stat">
                    <h3>2</h3>
                    <p class="stat-detail">Number of Reviews</p>
                </div>
                <div class="stat">
                    <h3>6</h3>
                    <p class="stat-detail">Number of Posts </p>
                </div>

             <div class="stat-bottom">
                <p class="stat-text1">Number of Post</p>
                <p class="stat-text2">3</p>
                <p class="stat-text1">Post Field</p>
                <p class="stat-text3">F Serie Visa</p>
            </div>  
        </div>
        <div class="stat-graph">
            <a href="dashboard.php" class="stat-summary"><p>Statistic Graph</p></a>
        </div>
        <div class="graph-box">
