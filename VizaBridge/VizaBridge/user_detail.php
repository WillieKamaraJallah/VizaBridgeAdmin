...
<div class="top-bar">
    ...
    <div class="container">
        ...
        <div class="head-div">
            <a href="user_detail.php" class="stat-summary"><p>User Detail</p></a>
        </div>
        <div class="stat-box">
            <form action="" name="">
            <div class="content-dtl">
                <div class="content-controller">
                    <p class="content-ttl">User Number</p>
                    <input type="text" class="content-body" name="" value="123456789">
                </div>
                <div class="content-controller1">
                    <p class="content-ttl">User Email</p>
                    <input type="text" class="content-body" name="" value="user@gmail.com">
                </div>
            </div>
            <div class="content-dtl">
                <div class="content-controller">
                    <p class="content-ttl">User Name</p>
                    <input type="text" class="content-body" name="" value="10228">
                </div>
                <div class="content-controller1">
                    <p class="content-ttl">Password</p>
                    <input type="text" class="content-body" name="" value="Pass1234">
                </div>
            </div>
        </div>
