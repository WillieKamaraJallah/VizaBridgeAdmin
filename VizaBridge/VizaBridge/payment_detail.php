...
<div class="top-bar">
    ...
    <div class="container">
        ...
        <div class="head-div">
            <a href="payment_detail.php" class="stat-summary"><p>Payment Detail</p></a>
        </div>
        <div class="stat-box">
            <form action="" name="">
            ...
            <div class="content-dtl">
                <div class="content-controller">
                    <p class="content-ttl">Payment Number</p>
                    <input type="text" class="content-body" name="" value="10228">
                </div>
                <div class="content-controller1">
            ...
            <div class="btn-controller">
                <input 
                type="button" class="delete-btn-pmt" name="" value="Delete">
            </div>
            </form>
